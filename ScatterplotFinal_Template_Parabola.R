####FINAL SCATTERPLOT W/ QUADRATIC REGREESIONS CODE####
...
####Li/Ca####
#CalcRate
#plotting X/Ca against carbonate parameter with points, quadratic regression line, and 
...
#creating model for quadratic regression
lmModel <-lm(Li_Ca ~ CalcRate + I(CalcRate^2), data = subset_data)
...
lmModel <-lm(Li_Ca ~ carbion + I(carbion^2), data = subset_data)
...
lmModel <-lm(Li_Ca ~ Alk + I(Alk^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Li_Ca ~ pH + I(pH^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Li_Ca ~ pH_cf + I(pH_cf^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(B_Ca ~ CalcRate + I(CalcRate^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(B_Ca ~ carbion + I(carbion^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(B_Ca ~ Alk + I(Alk^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(B_Ca ~ pH + I(pH^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(B_Ca ~ pH_cf + I(pH_cf^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Mg_Ca ~ CalcRate + I(CalcRate^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Mg_Ca ~ carbion + I(carbion^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Mg_Ca ~ Alk + I(Alk^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Mg_Ca ~ pH + I(pH^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Mg_Ca ~ pH_cf + I(pH_cf^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Zn_Ca ~ CalcRate + I(CalcRate^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Zn_Ca ~ carbion + I(carbion^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Zn_Ca ~ Alk + I(Alk^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Zn_Ca ~ pH + I(pH^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Zn_Ca ~ pH_cf + I(pH_cf^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Sr_Ca ~ CalcRate + I(CalcRate^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Sr_Ca ~ carbion + I(carbion^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Sr_Ca ~ Alk + I(Alk^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Sr_Ca ~ pH + I(pH^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Sr_Ca ~ pH_cf + I(pH_cf^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Cd_Ca ~ CalcRate + I(CalcRate^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Cd_Ca ~ carbion + I(carbion^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Cd_Ca ~ Alk + I(Alk^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Cd_Ca ~ pH + I(pH^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Cd_Ca ~ pH_cf + I(pH_cf^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Ba_Ca ~ CalcRate + I(CalcRate^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Ba_Ca ~ carbion + I(carbion^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Ba_Ca ~ Alk + I(Alk^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Ba_Ca ~ pH + I(pH^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Ba_Ca ~ pH_cf + I(pH_cf^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(U_Ca ~ CalcRate + I(CalcRate^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(U_Ca ~ carbion + I(carbion^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(U_Ca ~ Alk + I(Alk^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(U_Ca ~ pH + I(pH^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(U_Ca ~ pH_cf + I(pH_cf^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Na_Ca ~ CalcRate + I(CalcRate^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Na_Ca ~ carbion + I(carbion^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Na_Ca ~ Alk + I(Alk^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Na_Ca ~ pH + I(pH^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
lmModel <-lm(Na_Ca ~ pH_cf + I(pH_cf^2), data = subset_data)
rsqu <- summary(lmModel)$adj.r.squared
fs <- summary(lmModel)$fstatistic
pValue <- pf(fs[1], fs[2], fs[3], lower.tail = FALSE)
...
filename <- paste0(subset_data$Organism[1],"_parabola_final_check",".png") 
